...
public class UpdateStudentPasswordAdminHubController extends AdminHubController{
    @FXML
    ...
    public void updateStudentPassword(ActionEvent event){
        try{
            ...
            if (usernameField.getText().trim().equals("") || newPassword.getText().equals("")){
                ...
                if (!(newPassword.getText().equals(confirmNewPassword.getText()))){
                    ...
                    if ((newPassword.getText().trim().matches(passwordRegex))) {
                        ...
                        if (resultSet.next()) {
                            query = connection.prepareStatement("update studentlogin set password=? where username=?");
